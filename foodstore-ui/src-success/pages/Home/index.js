...
export default function Home(){
  ...
  let [currentDelete, setCurrentDelete] = React.useState('');

  // let [deleteProduct, setDeleteProduct] = React.useState(false);
       ...
       <LayoutSidebar
         ...
         content={<div className="md:flex md:flex-row-reverse w-full mr-5 h-full min-h-screen">
          ...
          <div className="w-full md:w-3/4 pl-5 pb-10">
            ...
            <TopBar/>
            <Button text="Tambah" color="blue" onClick={_ =>  history.push(`/product/add`)}/>
           ...
           <div className="mb-5 pl-2 flex w-3/3 overflow-auto pb-5">
             ...
             return <div key={index}>
               ...
               />
                   ...
                   color = 'red'
								 />
                 <Button text="Edit" color="blue" onClick={_ =>  history.push(`/product/${product._id}`)}/>
                 <Button text="Delete" color="red" onClick={_ => setCurrentDelete(removeProduct(product._id))}/>
								</div>
							})}
						</Responsive>
